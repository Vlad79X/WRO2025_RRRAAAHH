...
MSGandCLOSE(80,9*cm,0,1,1,57)
wait(200)
MoveSyncGyro(-80,13*cm,1,1,1)
wait(100)
RobotSpin(90,90,STANGA)
wait(50)
MoveSyncGyro(90,72*cm,1,1,1)
run_task(clawGoTo(OPEN,1,0,450))
MoveSyncGyro(-90,65*cm,1,1,1)
wait(100)
RobotCompas(-80,84.5,STANGA,0,1,1,10)

run_task(liftGoTo(20,2,0,400))
run_task(liftGoTo(5.5,1,0,200))
# run_task(clawGoTo(OPEN,1,0,450))
#wait(50)
MoveSyncGyro(70,25.5*cm,1,0,0)
MoveTime(60,0.4,0,1)
#wait(50)
run_task(clawGoTo(CLOSED,1,0,450))   
