...
if cpatrat == 2:
    ...
    wait(100)
    MoveSyncGyro(-70,30*cm,0,0,0)
    SquaringBlackSA(-60,45,4,"red",45*cm,0,0,0)
    MoveSyncGyro(-60,7*cm,0,1,1)
    wait(50)
    MoveSyncGyro(80,23*cm,1,1,1)
    wait(50)
    RobotCompas(-90, 86, DREAPTA, 0, 1, 1, 20)
    wait(50)
    MoveSyncGyro(-80,7*cm,1,0,0)
    MoveTime(-70,0.6,0,1)
elif cpatrat == 4:
    # galben
    MoveSyncGyro(80,30.5*cm,1,1,1)
    wait(50)
    RobotSpin(80,89,STANGA,1,0,1,1)
    wait(50)
    MoveSyncGyro(-80,75*cm,1,0,0)
    MoveTime(-80,0.2,0,1)
    MoveSyncGyro(80,11*cm,1,1,1)
    wait(50)
    RobotCompas(60, 89, DREAPTA, 0, 1, 1, 0)
    wait(50)
    MoveSyncGyro(60,4.5*cm,0,0,1)
    ...
    wait(50)
    RobotCompas(-90, 89, DREAPTA, 0, 1, 1, 20)
    wait(50)
    MoveSyncGyro(-80,7*cm,1,0,0)
    MoveTime(-70,0.6,0,1)
elif cpatrat == 3:
    ...
    SquaringBlackSA(70,45,4,"red",55*cm,0,0,0)
    ...
    wait(100)
    RobotCompas(80,48,DREAPTA,0,1,1,10)
    wait(100)
    run_task(clawGoTo(CLOSED,1,0,450))
    MoveSyncGyro(80,15*cm,1,1,1)
    wait(10)
    RobotCompas(80,48,STANGA,0,1,1,10)
    wait(100)
    MoveSyncGyro(80,3*cm,1,0,0)
    SquaringBlackSA(70,45,4,"red",5*cm,0,0,0)
    MoveSyncGyro(65,3*cm,0,1,1)
    wait(100)
    MoveSyncGyro(-75,5.5*cm,0,1,1)
    wait(100)
    RobotCompas(90, 88, DREAPTA, 0, 1, 1, 30)
...
SquaringBlackSA(60,30,2,"blue",43*cm,0,0,0)
