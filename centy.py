...
# steag alb
MSGandCLOSE(90,10*cm,1,0,0,80)
LFEncoderSA(90,21*cm,0.5,1.65,3,5,"red",0,1,1)
wait(50)
imux = Brick.imu.rotation(TopAxis) - 90
RobotSpin(80,90,STANGA,1,0,1,1)
wait(100)
MSGandCLOSE(90,51*cm,1,1,1,0,25)
# run_task(liftGoTo(50,3,0,450))
# MoveSyncGyro(90,51*cm,1,1,1)
run_task(liftGoTo(10,3,0,450))
# gata steag alb

run_task(liftGoTo(40,2,0,400))
#wait(100)
...
if cpatrat == 1:
    ...
    wait(50)
    MoveTime(-70,1,1,1)
    MoveSyncGyro(90,12*cm,1,0,0)
    MSGandCLOSE(90,18*cm,0,0,0,48)
    SquaringWhiteSA(80,40,4,"red",0,0,0)
...
# wait(100)
RobotCompas(95,53,DREAPTA,1,1,1,25)
wait(100)
RobotCompas(95,52,STANGA,1,1,1,25)
wait(100)
...
#wait(100)
run_task(clawGoTo(SEMIOPEN+50,1,0,450))
...
MSGandCLOSE(70,23.5*cm,1,0,0,-30)
MoveTime(60,0.4,0,1)
#wait(50)
run_task(clawGoTo(CLOSED,1,0,450))   
MoveSyncGyro(-90,11*cm,1,1,1)
run_task(clawGoTo(OPEN,2,0,450))
MoveSyncGyro(-90,20*cm,1,0,0)
MoveTime(-80,0.7,0,1)
# gata gard rosu
...
MSGandCLOSE(60,2*cm,0,1,1,-80)
run_task(clawGoTo(OPEN,1,0,200))
wait(50)
